...
export default function GetQuotePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      {/* Form card */}
      <div className="rounded-2xl border border-brand-800 bg-brand-900/40 p-6 sm:p-8 lg:p-10">
        <QuoteForm />
      </div>
...
function Perk({
  ...
  return (
    <div className="rounded-xl border border-brand-800 bg-brand-900/30 p-6">
