...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <h1 className="text-4xl sm:text-5xl font-bold text-jtc-charcoal mb-8 text-center">
        About <span className="text-brand-800">Junk That Car</span>
      </h1>

      {/* Story */}
      <div className="prose prose-invert max-w-none mb-16">
        <p className="text-lg text-jtc-charcoal leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold text-jtc-charcoal mt-10 mb-4">Why We&apos;re Different</h2>
        <p className="text-lg text-jtc-charcoal leading-relaxed mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        {stats.map(({ icon: Icon, value, label }) => (
          <div
            key={label}
            className="bg-white border border-jtc-border rounded-xl p-8 text-center"
          >
            <Icon className="w-8 h-8 text-brand-800 mx-auto mb-3" />
            <div className="text-3xl font-bold text-jtc-charcoal mb-1">{value}</div>
            <div className="text-jtc-slate text-sm">{label}</div>
          </div>
        ))}
      </div>

      {/* CTA */}
      <div className="text-center bg-white border border-jtc-border rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-jtc-charcoal mb-3">Ready to sell your car?</h2>
